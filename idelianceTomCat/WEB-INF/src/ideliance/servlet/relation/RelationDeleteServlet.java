...
public class RelationDeleteServlet extends HttpServlet {
	public static final Logger log = Logger.getLogger(RelationDeleteServlet.class);
	...
	public void init() {
		...
		try {
			...
			log.error("Error during RelationDeleteServlet initialization", e);
		}
	}
