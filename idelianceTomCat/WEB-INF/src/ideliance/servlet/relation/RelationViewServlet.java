...
public class RelationViewServlet extends HttpServlet {
	public static final Logger log = Logger.getLogger(RelationViewServlet.class);
	...
	public void init() {
		...
		try {
			...
			log.error("Error during RelationViewServlet initialization", e);
		}
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		try {
			...
			List<Triplet> listTriplets = tripletDao.selectAllByRelation(r.getId());
			
			request.setAttribute("relation", r);
			request.setAttribute("listTriplet", listTriplets);
			
			request.getRequestDispatcher("/WEB-PAGES/Relation/viewRelation.jsp").forward(request, response);
		} catch (DAOException e) {
